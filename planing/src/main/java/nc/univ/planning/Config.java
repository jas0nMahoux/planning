...
@ComponentScan(basePackages = { "nc.univ.planning.service" })
@EnableJpaRepositories(basePackages = { "nc.univ.planning.dao" }) // active les repositories
public class Config {
    ...
    /**
     * Retourne le bean correspondant au manager des transactions
     * @param emf
     * @return
     */
    @Bean
